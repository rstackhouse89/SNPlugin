...
//                int confirmed = JOptionPane.showConfirmDialog(null, "You are attempting to set this project's root directory to " + folderName + ". This is the root folder of the Service Now File Cabinet. \nThis is not recommended. Are you sure?",  "WARNING", JOptionPane.CANCEL_OPTION);
//                if (confirmed != 0) {
//                    return;
//                }
